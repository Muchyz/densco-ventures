...
export const careerRoles = [
  {
    ...
    requirements: [
      'Own application letter (hand written)',
      'Printed updated CV',
      'Valid certificate of good conduct',
      '2 recent coloured passport photos',
      'Introduction letter from local area chief (preferably upcountry)',
      'Recommendation letter from previous employer, if any',
      'Copy of National ID card',
      'Age between 23 and 40 years',
      'Letters from 2 referees, copy of their ID, and 1 must be a close relative',
      'Copies of academic certificates (minimum KCSE Grade D)',
      'Copies of NSSF, SHA, KRA and bank account details',
      'Medical certificate from a recognized GOK facility',
      'Physically fit, minimum height 5\'8"',
      'Sketch map to current residence and upcountry home',
    ],
  },
  {
    id: 'guard-guardess',
